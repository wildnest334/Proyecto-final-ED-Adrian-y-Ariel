...
public class ConcurrentSortingProject {
 ...
 //1.Introducción y Objetivo del Proyecto   
    ...
    // 3.Clase SortType
    // aqui combinamos los algoritmo con la estructura 
...
//AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
    //4. Clase SortTask y ejecución de hilos
    public static class SortTask implements Runnable {
        ...
        public void run() {
            ...
            // El hilo anda en bucle hasta que se cumpla la restricción de tiempo si quiere pq nunca jala
       ...
       //5. Implementación de algoritmos (Array y ArrayList)
        private void executeArraySort(int[] arr, SortAlgorithm algo) {
            switch (algo) {
                ...
                case QUICK_SORT: 
                    if (arr.length > 1) quickSortIterative(arr, 0, arr.length - 1); 
                    break;
                case COUNTING_SORT:
                    int maxVal = 0;
        ...
        private void executeListSort(List<Integer> list, SortAlgorithm algo) {
            switch (algo) {
                ...
                case QUICK_SORT: 
                    if (list.size() > 1) quickSortListIterative(list, 0, list.size() - 1); 
                    break;
                case COUNTING_SORT:
                    int maxVal = list.stream().mapToInt(v -> v).max().orElse(0); 
...
//6. Lógica Principal (main)
    ...
    public static void main(String[] args) {
        ...
        // Aqui le pedimos al usuario que diga cuanto tiempo quiere que dure
        ...
        // Aqui empezamos con los 12 hilos en total
        ...
        // Nos esperamos a que todos los hilos terminen
        for (Thread thread : threads) {
            try {
                thread.join(); 
...
//7. Procesamiento y Presentación de Resultados

        // Checamos y avr los resultados
